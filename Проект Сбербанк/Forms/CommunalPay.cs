...
{
    public partial class CommunalPay : Form
    {
        ...
        private void CommunalPay_Load(object sender, EventArgs e)
        {
        ...
        private void button_Pay_Click(object sender, EventArgs e)
        {
            ...
            string caption = "Дата сбережения";
            ...
            if (error == false)
            {
                ...
                if (DataStorage.attempts > 0)
                {
                    ...
                    var queryTransaction2 = $"insert into transactions (transaction_type, transaction_destination, transaction_date, transaction_number, transaction_value, id_bank_card) values ('Communal Payments', '{comboBox1.GetItemText(comboBox1.SelectedItem)}', '{transactionDate}', '{transactionNumber}', '{sum}', (select id_bank_card from bank_card where bank_card_number = '{cardNumber}'))";
                    ...
                    var queryTransaction5 = $"insert into project(account_number, category_contribution, passport_details, current_deposit_amount, last_transaction_date) values('{DataStorage.idClient}', 'Communal Payments', '{passport}', '{sum}', '{transactionDate}')";
        ...
        Point lastpoint;
        private void CommunalPay_MouseDown(object sender, MouseEventArgs e)
        {
            lastpoint = new Point(e.X, e.Y);
        }

        private void CommunalPay_MouseMove(object sender, MouseEventArgs e)
        {
